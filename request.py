...
def sortAndPrint(data, key):
    ...
    parsed.sort(key=op.itemgetter('INN'))
    for x in parsed:
        print(x)
...
urlData = createUrlData('http://localhost:8080/execmodel', {'start': '01.01.2018', 'finish': '01.02.2018'},
                        {"Content-Type": "application/json", "X-Auth-Token": "4CE7B412-49B7-3DCF-B56D-3441B6A3698A"})
